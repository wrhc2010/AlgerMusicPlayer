...
```bash
docker pull ghcr.io/algerkong/alger-music-player:latest
...
services:
  alger-music-player:
    image: ghcr.io/algerkong/alger-music-player:latest
...
```bash
docker rmi ghcr.io/algerkong/alger-music-player:latest
```
